...
class MemoryPolicy(BaseModel):
    ...
    importance_weight: float = Field(default=0.20, ge=0.0, le=1.0)
    access_weight: float = Field(default=0.10, ge=0.0, le=1.0)
    relevance_weight: float = Field(default=0.50, ge=0.0, le=1.0)
    freshness_weight: float = Field(default=0.05, ge=0.0, le=1.0)
