...
- **Local CLI**: Initialize workspaces, manage memories, search, and build context from the command line.
...
<CardGroup cols={2}>
  ...
  <Card title="Mneno CLI" icon="terminal" href="/advanced/cli">
    Manage your memories from the command line.
  </Card>
